...
function Resume() {
    ...
    return (
      <div id='resumeContainer'>
        ...
        <div class="section">
            <h2>EDUCATION</h2>
            <p><strong>University of Central Florida, Orlando, FL</strong> <span class="date">Graduation, September 2024</span><br />
            Bootcamp, Full-Stack Web Development</p>
            <p><strong>University of Central Florida, Orlando, FL</strong> <span class="date">Graduation, August 2016</span><br />
            BS, Psychology</p>
            <ul>
        ...
        <div class="section">
            ...
            <p><strong>MotionCX, Columbus, OH</strong> <span class="date">July 2023 - Present</span><br />
            <span class="job-title">Solutions Specialist</span></p>
            <ul>
            ...
            <p><strong>CreditPoint Software, Tulsa, OK</strong> <span class="date">January 2023 - July 2023</span><br />
            <span class="job-title">Business Development Strategist</span></p>
            <ul>
            ...
            <p><strong>Independent Contractor, Orlando, FL</strong> <span class="date">February 2017 - December 2022</span><br />
            <span class="job-title">Realtor</span></p>
            <ul>
            ...
            <p><strong>Independent Contractor, Orlando, FL</strong> <span class="date">February 2017 - December 2019</span><br />
            <span class="job-title">Insurance Broker</span></p>
            <ul>
